...
export const projetos: ProjetoLocal[] = [
  {
    ...
    fotos: ['/assets/images/IMG_9266.PNG'],
    shareText:
  ...
  },
  {
    ...
    categoria: 'Social',
    fotos: ['/assets/images/IMG_9269.PNG'],
    shareText:
  ...
  },
  {
    ...
    categoria: 'Esporte',
    fotos: ['/assets/images/IMG_9271.PNG'],
    shareText:
  ...
  },
  {
    ...
    categoria: 'Social',
    fotos: ['/assets/images/IMG_9272.PNG'],
    shareText:
  ...
  },
  {
    ...
    categoria: 'Lazer',
    fotos: ['/assets/images/IMG_9275.PNG'],
    shareText:
  ...
  },
  {
    ...
    categoria: 'Eventos',
    fotos: ['/assets/images/IMG_9277.PNG'],
    shareText:
