...
export default function Hero() {
  ...
  return (
    ...
    >
      {/* ===== MOBILE: image as normal-flow block ===== */}
      <div className="md:hidden relative w-full h-[70vh] min-h-[420px]">
        <div
      ...
      {/* ===== MOBILE: CTAs + headline below image ===== */}
      <div className="md:hidden relative z-10 px-5 pt-8 pb-12 bg-gray-900">
        <motion.div
