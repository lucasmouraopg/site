...
export default function Hero() {
  ...
  if (isMobile) {
    return (
      ...
      >
        {/* Hero image - fills width, fixed aspect */}
        ...
        {/* CTA buttons + headline stacked vertically */}
        <div className="relative z-10 px-5 pt-8 pb-12 bg-gray-900">
          <motion.div
  ...
  return (
    <section
      id="home"
      ref={containerRef}
      className="relative h-[90vh] overflow-hidden bg-gray-900"
    >
      ...
      <motion.div
        style={{ opacity }}
        className="absolute bottom-12 left-0 z-10 px-4 sm:px-6 lg:px-8 w-full max-w-7xl mx-auto"
      >
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
